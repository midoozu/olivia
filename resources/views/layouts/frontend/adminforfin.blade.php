...
<head>
    ...
    <link href="{{ asset('css/adminltev31.css') }}" rel="stylesheet" />
    ...
    <link rel="stylesheet" href="{{asset('admin/backEndFiles/validation/toastr.min.css')}}">
    ...
    @yield('styles')
        ...
        <link href="{{ asset('css/arabic1.css') }}" rel="stylesheet" />
        @else
        <link href="{{ asset('css/custom1.css') }}" rel="stylesheet" />
...
<script src="{{asset('admin/backEndFiles/validation/toaster-display.js')}}"></script>
<script src="{{asset('admin/backEndFiles/validation/toastr.min.js')}}"></script>
<script src="{{asset('admin/backEndFiles/validation/sweetalert.min.js')}}"></script>
<script src="{{asset('admin/backEndFiles/validation/jquery.validate.js')}}"></script>
<script src="{{asset('admin/backEndFiles/validation/jquery.magnific-popup.js')}}"></script>
<script src="{{asset('admin/backEndFiles/validation/jquery.fileupload.js')}}"></script>
<script src="{{asset('admin/backEndFiles/validation/jquery.fancy-fileupload.js')}}"></script>
...
{{--            var op = $(this)--}}
{{--            op.removeClass('menu-open')--}}

{{--            $('.nav-item a').each(function() {--}}
{{--                var newHref = $(this).attr('href')--}}
{{--                console.log(newHref)--}}
{{--                if (newHref == window.location.href){--}}
{{--                    op.addClass('menu-open')--}}
{{--                }--}}
{{--            })--}}
