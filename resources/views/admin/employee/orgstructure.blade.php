...
<style>
    ...
    .analytics-sparkle-area .nav-tabs li a{
        padding: 0px 5px ;
        color: #0b2e13;

    }
    .analytics-sparkle-area .nav-tabs li:after  {
        content:" / ";
        margin: 0px 3px;

    }
    .analytics-sparkle-area .nav-tabs li:last-child:after {
        display: none;

    }
    .analytics-sparkle-area .nav-tabs li.active a{
        color:#0000cc;
    }
    .main-header {
...
<ul class="nav nav-tabs">
    <li class="active"><a data-toggle="tab" class="TabClick" href="#home" >إدارة الاقسام</a></li>
    <li ><a data-toggle="tab" href="#menu11" class="TabClick">إدارة التعيين</a></li>
    <li ><a data-toggle="tab" href="#menu2" class="TabClick">إدارة المستوي الوظيفي</a></li>
  </ul>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="{{route('admin.add_new_department')}}" method="post">
            @csrf
 ...
 <table class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            @if($value->status == 0)
            <a href="{{url('admin/department_activation')}}/{{$value->id}}/1" class="btn btn-success"><i class="fa fa-check"></i></a>
            @else
            <a href="{{url('admin/department_activation')}}/{{$value->id}}/0" class="btn btn-danger"><i class="fa fa-ban"></i></a>
            @endif
        </td>
      </tr>
      @endforeach
...
<div class="modal" id="myModalhire">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
        <form action="{{route('admin.add_new_job')}}" method="post">
            @csrf
     <div class="form-group">
 ...
 <table class="table table-bordered table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
            @if($value->status == 0)
            <a href="{{url('admin/job_activation')}}/{{$value->id}}/1" class="btn btn-success"><i class="fa fa-check"></i></a>
            @else
            <a href="{{url('admin/job_activation')}}/{{$value->id}}/0" class="btn btn-danger"><i class="fa fa-ban"></i></a>
            @endif
        </td>
      </tr>
      @endforeach
