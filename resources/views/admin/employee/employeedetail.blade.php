...
@section('content')
        ...
        <div class="analytics-sparkle-area">
            <div class="container-fluid">
			<div class="col-md-6">
    <a href="{{url('admin/editemployee')}}/{{$empdetail->id}}" class="btn btn-info">
            <i class="fa fa-edit" aria-hidden="true"></i> تعديل بيانات</a>
</div>
                      <div class="col-md-6" style="text-align:left;">
            @if($empdetail->isActive != 2)
            <a href="{{url('admin/employee_activation')}}/{{$empdetail->id}}/2" class="btn btn-warning">
            <i class="fa fa-minus-circle" aria-hidden="true"></i> تعليق</a>
            @endif
            @if($empdetail->isActive != 1)
            <a href="{{url('admin/employee_activation')}}/{{$empdetail->id}}/1" class="btn btn-success">
            <i class="fa fa-check" aria-hidden="true"></i> تفعيل</a>
            @endif
            @if($empdetail->isActive != 3)
            <a href="{{url('admin/employee_activation')}}/{{$empdetail->id}}/3" class="btn btn-danger">
