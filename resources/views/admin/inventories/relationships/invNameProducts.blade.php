    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-invNameProducts">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($products as $key => $product)
                            <tr data-entry-id="{{ $product->id }}">
                                ...
                                <td>
                                    @foreach($product->atts as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-invNameProducts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
