    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-branchIncomes">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.income.fields.cs_name') }}
                            </th>
                            <th>
                                {{ trans('cruds.crmCustomer.fields.phone') }}
                            </th>
                            <th>
                                {{ trans('cruds.income.fields.branch') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($incomes as $key => $income)
                            <tr data-entry-id="{{ $income->id }}">
                                ...
                                <td>
                                    {{ $income->cs_name->first_name ?? '' }}
                                </td>
                                <td>
                                    {{ $income->cs_name->phone ?? '' }}
                                </td>
                                <td>
                                    {{ $income->branch->name ?? '' }}
                                </td>
...
@endcan
  ...
  let table = $('.datatable-branchIncomes:not(.ajaxTable)').DataTable({ buttons: dtButtons })
