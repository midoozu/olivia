...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a href="{{route('admin.receipt.create')}}" id="" class="btn mb-2 btn-success "> أضف <span class="icon-add_circle"></span>  </a>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click','#addButton',function (e) {
            e.preventDefault()
            var url = '{{route('admin.receipt.create')}}';
            $.ajax({
                url: url,
                type: 'GET',
                beforeSend: function(){
        ...
        $(document).on('click','.editButton',function (e) {
            ...
            var url = '{{route('admin.receipt.edit',":id")}}';
        ...
        $(document).on('click','.showButton',function (e) {
            ...
            var url = '{{route('admin.receipt.show',":id")}}';
            url = url.replace(':id', id);
        ...
        $(document).on('click', '.delete', function () {
            ...
            swal({
                ...
                var url = '{{ route("admin.receipt.destroy", ":id") }}';
                url = url.replace(':id', id);
                console.log(url);
                $.ajax({
                    url: url,
