...
@section('content')
    ...
    <div class="card">
        ...
        <form action="{{route('admin.receipt.store')}}" method="post" id="Form" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-lg-3 col-md-6  mb-3">
            ...
            <select class="  form-control" id="debit" name="creditor_id" data-validation="required">
                ...
                @foreach($madins as $madin)
                    <option value="{{$madin->id}}" > {{$madin->name}} </option>
                @endforeach
        ...
        <div class="col-lg-3 col-md-6  mb-3">
            ...
            <select id="PayType" name="payment_type" class="form-control " data-validation="required">
                ...
                @foreach($pay_types as $pay_type)
                    <option value="{{$pay_type->payment_type}}">{{$pay_type->payment_type}}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="col-lg-3 col-md-6  mb-3">
            ...
            <select id="creditor2" name="box_id" class="form-control " data-validation="required">
                ...
                @foreach($box_accounts as $box_account)
                    <option value="{{$box_account->id}}" >{{$box_account->name}}</option>
                @endforeach
            </select>
        </div>
