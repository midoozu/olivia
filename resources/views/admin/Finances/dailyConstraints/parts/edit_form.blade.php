...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
        <form action="{{route('admin.dailyConstraints.update',$find->id)}}" method="post" id="Form">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6  mb-4">
                    ...
                    <textarea  name="main_statement" rows="3" style="height: auto!important;" class="form-control" >{{$find->statement}}</textarea>
                </div>
                ...
                <div class="table-responsive-md col-sm-12">
                    <table class="table table-striped-table-bordered table-hover table-checkable table-" id="tbl_posts">
                        ...
                        <tr id="rec-madeen-{{$key + 1}}" class="madeen">
                            ...
                            <td>
                                <textarea class="form-control" name="statement_madeen[]" style="height: auto;">{{$debit_details->statement}}</textarea>
                            </td>
                        ...
                        <tr id="rec-dayyen-{{$key2 + 1}}" class="dayyen">
                            ...
                            <td>
                                <textarea class="form-control" name="statement_dayyen[]" style="height: auto;">{{$creditor_details->statement}}</textarea>
                            </td>
