...
<div class="wrapper">
    ...
    <div class="content-wrapper" style="margin-right: auto!important;">
        <!-- Main content -->
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row" style="margin: 10px">
                                ...
                                <div class="table-responsive-md col-sm-12" id="TableSearch" >

                                    <div class="p-3 bg-gray">
                                        <h4 class="font-weight-bold text-center"> قائمة الدخل  </h4>
                                        <div class="text-center">
                                            <p style="display: inline-block"  id="FromText"> من {{$request->FromDate}} </p>

                                            <p style="display: inline-block;margin-right: 20px" id="ToText">   إلى {{$request->ToDate}}   </p>
                                        </div>
                                    </div>
