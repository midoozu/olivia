    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-shippingCoOrders">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.order.fields.cus_name') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.order.fields.track_code') }}
                            </th>
                            <th>
                                {{ trans('cruds.order.fields.status') }}
                            </th>
                            <th>
                                {{ trans('cruds.order.fields.shipping_co') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($orders as $key => $order)
                            <tr data-entry-id="{{ $order->id }}">
                                ...
                                <td>
                                    {{ $order->cus_name->first_name ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->email ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->phone ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->address ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->website ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->description ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->gov ?? '' }}
                                </td>
                                <td>
                                    {{ $order->cus_name->phone_2 ?? '' }}
                                </td>
                                <td>
                                    {{ $order->total_price ?? '' }}
                                </td>
...
@endcan
  ...
  let table = $('.datatable-shippingCoOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
