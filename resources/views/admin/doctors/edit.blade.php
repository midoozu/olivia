    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.doctors.update", [$doctor->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('phone') ? 'is-invalid' : '' }}" type="number" name="phone" id="phone" value="{{ old('phone', $doctor->phone) }}" step="1" required>
                @if($errors->has('phone'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('min_amount') ? 'is-invalid' : '' }}" type="number" name="min_amount" id="min_amount" value="{{ old('min_amount', $doctor->min_amount) }}" step="0.01" required>
