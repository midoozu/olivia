...
<div class="card">
    ...
    <ul class="nav nav-tabs" role="tablist" id="relationship-tabs">
        <li class="nav-item">
            <a class="nav-link" href="#services_doctors" role="tab" data-toggle="tab">
    ...
    <div class="tab-content">
        <div class="tab-pane" role="tabpanel" id="services_doctors">
            @includeIf('admin.services.relationships.servicesDoctors', ['doctors' => $service->servicesDoctors])
        </div>
