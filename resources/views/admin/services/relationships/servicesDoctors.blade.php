    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-servicesDoctors">
                    <thead>
                        <tr>
                            <th width="10">
                    ...
                    <tbody>
                        @foreach($doctors as $key => $doctor)
                            <tr data-entry-id="{{ $doctor->id }}">
                                ...
                                <td>
                                    @foreach($doctor->services as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-servicesDoctors:not(.ajaxTable)').DataTable({ buttons: dtButtons })
