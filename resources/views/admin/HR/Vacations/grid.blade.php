...
{{--    <link rel="stylesheet" href="{{asset('admin/backEndFiles/sweetalert/sweetalert.css')}}">--}}
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a href="{{route('admin.HREmployeeVacations.create')}}" class="btn mb-2 btn-success "> أضف <span class="icon-add_circle"></span>  </a>

        </div>
    </div>
    <div class="card">
        <div class="card-header">
            {{ trans('hr.HREmployeeVacations') }}
        </div>
        <div class="card-body">
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "columns": [
                ...
                {"data": "vacation_id",   orderable: true,searchable: true},
                {"data": "from_date",   orderable: true,searchable: true},
                {"data": "to_date",   orderable: true,searchable: true},
