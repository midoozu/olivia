...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a href="{{route('admin.HREmployeeEvaluations.create')}}" class="btn mb-2 btn-success "> أضف <span class="icon-add_circle"></span>  </a>

        </div>
    </div>
    <div class="card">
        <div class="card-header">
            {{ trans('hr.HREmployeeEvaluations') }}
        </div>
        <div class="card-body">
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "columns": [
                ...
                {"data": "job_id",   orderable: true,searchable: true},
