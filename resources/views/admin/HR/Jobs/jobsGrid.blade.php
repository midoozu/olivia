...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a href="{{route('admin.HRJobs.create')}}" class="btn mb-2 btn-success "> أضف <span class="icon-add_circle"></span>  </a>
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "columns": [
                ...
                {"data": "max_salary",   orderable: true,searchable: true},
                {"data": "min_salary",   orderable: true,searchable: true},
