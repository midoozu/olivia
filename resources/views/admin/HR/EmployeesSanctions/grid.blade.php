...
@section('content')
    ...
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a href="{{route('admin.HREmployeeSanctions.create')}}" class="btn mb-2 btn-success "> أضف <span class="icon-add_circle"></span>  </a>
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "columns": [
                ...
                {"data": "sonction_id",   orderable: true,searchable: true},
