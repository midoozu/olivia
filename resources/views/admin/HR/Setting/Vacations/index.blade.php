...
@section('scripts')
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "searching": true,
            'iDisplayLength': 20,
            "ajax": "{{route('admin.hrVacations.index')}}",
            "columns": [
        ...
        $(document).on('click','#addButton',function (e) {
            e.preventDefault()
            $('.loader-ajax').show()
            var url = '{{route('admin.hrVacations.create')}}';
            $.ajax({
                url: url,
                type: 'GET',
                beforeSend: function(){
        ...
        $(document).on('click','.editButton',function (e) {
            ...
            var url = '{{route('admin.hrVacations.edit',":id")}}';
        ...
        $(document).on('click', '.delete', function () {
            ...
            swal({
                ...
                var url = '{{ route("admin.hrVacations.destroy", ":id") }}';
                url = url.replace(':id', id);
                console.log(url);
                $.ajax({
                    url: url,
