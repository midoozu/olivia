...
@section('scripts')
    ...
    <script>
        ...
        $("#test").DataTable({
            ...
            "searching": true,
            'iDisplayLength': 20,
            "ajax": "{{route('admin.hrDepartment.index')}}",
            "columns": [
        ...
        $(document).on('click','#addButton',function (e) {
            e.preventDefault()
            $('.loader-ajax').show()
            var url = '{{route('admin.hrDepartment.create')}}';
            $.ajax({
                url: url,
                type: 'GET',
                beforeSend: function(){
        ...
        $(document).on('click','.editButton',function (e) {
            ...
            var url = '{{route('admin.hrDepartment.edit',":id")}}';
        ...
        $(document).on('click', '.delete', function () {
            ...
            swal({
                ...
                var url = '{{ route("admin.hrDepartment.destroy", ":id") }}';
                url = url.replace(':id', id);
                console.log(url);
                $.ajax({
                    url: url,
