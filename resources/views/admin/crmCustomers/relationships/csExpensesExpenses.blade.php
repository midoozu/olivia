    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-csExpensesExpenses">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.expense.fields.cs_expenses') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($expenses as $key => $expense)
                            <tr data-entry-id="{{ $expense->id }}">
                                ...
                                <td>
                                    {{ $expense->cs_expenses->first_name ?? '' }}
                                </td>
                                <td>
                                    {{ $expense->branch->name ?? '' }}
                                </td>
...
@endcan
  ...
  let table = $('.datatable-csExpensesExpenses:not(.ajaxTable)').DataTable({ buttons: dtButtons })
