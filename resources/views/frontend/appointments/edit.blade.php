...
{{--                        </div>--}}
                        ...
                        <div class="form-group">
                            <label for="price">{{ trans('cruds.appointment.fields.price') }}</label>
                            <input class="form-control" type="number" name="price" id="price" value="{{ old('price', $appointment->price) }}" step="0.01">
                            @if($errors->has('price'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('price') }}
                                </div>
...
{{--                        </div>--}}
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="pulse" id="pulse" value="{{ old('pulse', $appointment->pulse) }}" step="1">
                            @if($errors->has('pulse'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('pulse') }}
                                </div>
