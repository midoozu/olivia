...
class ProductController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.products.create', compact('sizes', 'categories', 'atts', 'inv_names'));
    }
    ...
    public function edit(Product $product)
    {
        ...
        return view('frontend.products.edit', compact('sizes', 'categories', 'atts', 'inv_names', 'product'));
    }
