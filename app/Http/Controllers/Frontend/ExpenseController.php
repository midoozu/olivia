...
class ExpenseController extends Controller
{
    public function index()
    {
        ...
        $expenses = Expense::with(['expense_category', 'cs_expenses', 'branch'])->where('branch_id', Auth::user()->branch_id)->whereDate('entry_date',Carbon::today() )->get();
    ...
    public function create()
    {
        ...
        $cs_expenses = CrmCustomer::pluck('phone', 'id')->prepend(trans('global.pleaseSelect'), '');

        $branches = Inventory::where('id', Auth::user()->branch_id)->pluck('name', 'id')->prepend(trans('global.pleaseSelect'), '');

        return view('frontend.expenses.create', compact('expense_categories', 'cs_expenses', 'branches'));
    }
    ...
    public function edit(Expense $expense)
    {
        ...
        $expense->load('expense_category', 'cs_expenses', 'branch');

        return view('frontend.expenses.edit', compact('expense_categories', 'cs_expenses', 'branches', 'expense'));
    }
