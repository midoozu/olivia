...
class InventoryController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.inventories.index', compact('inventories'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.inventories.create');
    }
    ...
    public function store(StoreInventoryRequest $request)
    {
        ...
        return redirect()->route('frontend.inventories.index');
    }
    ...
    public function edit(Inventory $inventory)
    {
        ...
        return view('frontend.inventories.edit', compact('inventory'));
    }
    ...
    public function show(Inventory $inventory)
    {
        ...
        $inventory->load('invNameProducts', 'branchUsers', 'branchExpenses', 'branchIncomes');

        return view('frontend.inventories.show', compact('inventory'));
    }
