...
class UsersController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('frontend.users.create', compact('roles', 'branches'));
    }
    ...
    public function edit(User $user)
    {
        ...
        return view('frontend.users.edit', compact('roles', 'branches', 'user'));
    }
    ...
    public function show(User $user)
    {
        ...
        $user->load('roles', 'branch', 'userUserAlerts');
