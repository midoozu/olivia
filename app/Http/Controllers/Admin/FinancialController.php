...
class FinancialController extends Controller
{
    ...
    public function display_account_tree(Request $request){
    ...
    public function add_new_entry(Request $request){
        ...
        return redirect()->route('admin.dailyentrylist',['paginationVal'=>10]);
    }
    ...
    public function show_all_safes_banks(){
        $safe_banks = SafeBank::with('tree')->get();
        return view('admin.financial.treasurybanklist',compact('safe_banks'));
    }
    ...
    public function add_new_safe_bank(Request $request){
        ...
        Session::flash('success', 'تمت العملية بنجاح!');
        return redirect()->route('admin.treasurybanklist');
    }
