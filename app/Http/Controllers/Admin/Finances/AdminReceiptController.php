...
//                })
                ->addColumn('actions', function ($data) {
                    if ($data->is_confirmed == 'new'){
                        $html = "
                    <a href='".route('admin.receipt.show',$data->id)."'  class='btn mb-2 btn-warning' id='" . $data->id . "'> <i class='fa fa-eye'></i></a>
                    <a href='".route('admin.receipt.edit',$data->id)."' class='btn mb-2 btn-secondary' id='" . $data->id . "'> <i class='fa fa-edit'></i></a>
                     <form  method='post' action='".route('admin.receipt.destroy', $data->id)."'>
                    ...
                    <a href='".route('admin.receipt.print',$data->id)."'  class='btn mb-2 btn-info' id='" . $data->id . "'> <i class='fa fa-print'></i></a>
                        ";
                    }else{
                        $html = "
                    <a href='".route('admin.receipt.show',$data->id)."'  class='btn mb-2 btn-warning' id='" . $data->id . "'> <i class='fa fa-eye'></i></a>
